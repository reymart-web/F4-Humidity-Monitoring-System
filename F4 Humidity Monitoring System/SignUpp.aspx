...
<body>
     ...
     <asp:TextBox ID="TextBox3" runat="server" CssClass="txt3" placeholder="Username"></asp:TextBox>
       ...
       <br /> 
                  ...
                  <asp:Label ID="Label6" runat="server" CssClass="Address" Text="Address"></asp:Label><span>*</span>
<asp:TextBox ID="TextBox4" runat="server" CssClass="txt4" placeholder="Address"></asp:TextBox>
...
<br /> 
        <div class="Bttn">
         ...
         <asp:Button ID="Button1" runat="server" CssClass="btnlgn" Text="Submit" OnClick="Button1_Click1" />
                         <asp:Label ID="lblMessage" runat="server" Font-Bold="true" ForeColor="Green"></asp:Label> <br/>
